          ...
          <div style={{ marginTop: '0.75rem' }}>
            <SortableTable
              columns={[
                ...
                { key: 'sma200_1h', label: 'SMA200 1h', render: (_, row) => row.rsi?.sma200_1h != null ? formatPrice(row.rsi.sma200_1h) : (row.rsi?.sma200 != null ? formatPrice(row.rsi.sma200) : '-') },
                { key: 'sma200_4h', label: 'SMA200 4h', render: (_, row) => row.rsi?.sma200_4h != null ? formatPrice(row.rsi.sma200_4h) : '-' },
                { key: 'seguro', label: 'Seguro', render: (_, row) => row.rsi?.seguro ? <span style={{ color: 'var(--green)', fontWeight: 700 }}>SI</span> : '' },
          ...
          <>
            <SortableTable
              columns={[
                ...
                { key: 'sma200_1h', label: 'SMA200 1h', render: (_, row) => row.rsi?.sma200_1h != null ? formatPrice(row.rsi.sma200_1h) : (row.rsi?.sma200 != null ? formatPrice(row.rsi.sma200) : '-') },
                { key: 'sma200_4h', label: 'SMA200 4h', render: (_, row) => row.rsi?.sma200_4h != null ? formatPrice(row.rsi.sma200_4h) : '-' },
                { key: 'seguro', label: 'Seguro', render: (_, row) => row.rsi?.seguro ? <span style={{ color: 'var(--green)', fontWeight: 700 }}>SI</span> : (row.seguro ? <span style={{ color: 'var(--green)', fontWeight: 700 }}>SI</span> : '') },
...
function makeExportColumns(timezone) {
  ...
  { key: 'sma200', label: 'SMA 200 (Compra)', fmt: (_, t) => t.rsi?.sma200_1h != null ? formatPrice(t.rsi.sma200_1h) : (t.rsi?.sma200 != null ? formatPrice(t.rsi.sma200) : '') },
  { key: 'sma200_4h', label: 'SMA200 4h (Compra)', fmt: (_, t) => t.rsi?.sma200_4h != null ? formatPrice(t.rsi.sma200_4h) : '' },
  { key: 'seguro', label: 'Seguro', fmt: (_, t) => t.rsi?.seguro ? 'SI' : (t.seguro ? 'SI' : '') },
